...
describe("isHotForState", () => {
  ...
  it("OR: hot if between 97000 and 97999 inclusive", () => {
    ...
    expect(isHotForState("OR", "96999")).toBe(false);
    expect(isHotForState("OR", "98000")).toBe(false);
  });
...
describe("isHot (end-to-end)", () => {
  ...
  it("delegates to isHotForState rules", () => {
    ...
    expect(isHot("OR 98000")).toBe(false);
...
describe("randHot", () => {
  ...
  it("generates a hot zip for CA that should be hot by CA rules", () => {
    // This test will FAIL with your current code if CA generator produces 95500–95599
    // while CA hot rule is only 95500–95509.
